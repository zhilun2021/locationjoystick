...
Settings have their constants spread everywhere in the codebase, e.g. AppPreferencesDataSource, ExportData, SettingsViewModel, MockLocationService and so on they all define jitter settings etc. We want A SINGLE SOURCE OF TRUTH FILE for all of the constants in the codebase. Then the README.md and AGENTS.md shouldn't redefine them, it should just mention in which file all of the constants are located.
